...
export const Header = () => {
  ...
  const handleSubmit = (event) =>{
    ...
    event.target.reset();
    //returning http://localhost:3000/search?q=avatar
  ...
  return (
    <header>
      <nav className="bg-white border-b-2 border-gray-200 px-2 sm:px-4 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900">
        ...
        <div className="max-w-screen flex flex-wrap items-center p-4 justify-between mx-auto">
          ...
          <div className={`items-center justify-between ${hidden ? "hidden" : ""} w-full md:flex md:w-auto md:order-1`} id="navbar-search">
            ...
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                {/*when we click on any link it becomes active and other becomes inactive */}
